<?php
if($_GET['action'] == 'admin' && $_SESSION['id_role'] == 1){ ?>
<script>
  setTimeout(function() {
    alert("Accés refusé.");
  });
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Drop Down</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
            <ul>
              <li class="dropdown"><a href="#"><span>Mon compte</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                <ul>
                  <li><a href="#">Mon nom : <?php echo $_SESSION['nom_user']; ?></a></li>
                  <li><a href="#">Mon email : <?php echo $_SESSION['email_user']; ?></a></li>
        ...
        <div class="row gy-4 posts-list">
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="d-flex align-items-center">
                <img src="assets/images/blog/blog-author.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="d-flex align-items-center">
                <img src="assets/images/blog/blog-author-2.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="d-flex align-items-center">
                <img src="assets/images/blog/blog-author-3.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="d-flex align-items-center">
                <img src="assets/images/blog/blog-author-4.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="d-flex align-items-center">
                <img src="assets/images/blog/blog-author-5.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
          ...
          <div class="col-xl-4 col-md-6">
            <article>
              ...
              <div class="d-flex align-items-center">
                <img src="assets/images/blog/blog-author-6.jpg" alt="" class="img-fluid post-author-img flex-shrink-0">
                <div class="post-meta">
